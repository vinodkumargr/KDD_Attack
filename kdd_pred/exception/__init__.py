...
class KDDEXCEPTION(Exception):
    

    def __init__(self, error_message:Exception, error_detail:sys):
        super().__init__(error_message)
        self.error_message = KDDEXCEPTION.error_message_detail(error_message, error_detail=error_detail)
    ...
    def __repr__(self):
        ...
        """
        return KDDEXCEPTION.__name__.__str__()